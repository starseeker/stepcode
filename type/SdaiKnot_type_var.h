...
class SC_SCHEMA_EXPORT SdaiKnot_type_var  :  public SDAI_Enum  {
  ...
  public:
        SdaiKnot_type_var (const char * n =0, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_knot_type);
        SdaiKnot_type_var (Knot_type e, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_knot_type)
                : type(et) {  set_value (e);  }
...
class SdaiKnot_type_var_agg  :  public EnumAggregate  {
  ...
  public:
    SdaiKnot_type_var_agg( EnumTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_knot_type);
