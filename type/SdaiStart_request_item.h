...
// constructors
    SdaiStart_request_item( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_start_request_item );
    //  part 1
    SdaiStart_request_item( const SdaiProduct_definition_formation_ptr&,
                            const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_start_request_item );
...
class SdaiStart_request_item_agg : public SelectAggregate {
  ...
  public:
    SdaiStart_request_item_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_start_request_item );
