...
{
    return new SdaiPreferred_surface_curve_representation_var( "", ap242_managed_model_based_3d_engineering_mim_lf::t_preferred_surface_curve_representation );
}
...
{
    return new SdaiPreferred_surface_curve_representation_var_agg( ap242_managed_model_based_3d_engineering_mim_lf::t_preferred_surface_curve_representation );
}

void init_SdaiPreferred_surface_curve_representation_var( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_preferred_surface_curve_representation = new EnumTypeDescriptor (
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_preferred_surface_curve_representation);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_preferred_surface_curve_representation);
}
