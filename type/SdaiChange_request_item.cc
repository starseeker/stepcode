...
void init_SdaiChange_request_item( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_change_request_item = new SelectTypeDescriptor (
                  ~(0),        //unique elements,
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_change_request_item);
    ap242_managed_model_based_3d_engineering_mim_lf::t_change_request_item -> Elements ().AddNode (ap242_managed_model_based_3d_engineering_mim_lf::e_product_definition_formation);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_change_request_item);
}
