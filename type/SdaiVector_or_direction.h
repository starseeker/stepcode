...
// constructors
    SdaiVector_or_direction( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_vector_or_direction );
    //  part 1
    SdaiVector_or_direction( const SdaiDirection_ptr&,
                             const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_vector_or_direction );
...
class SdaiVector_or_direction_agg : public SelectAggregate {
  ...
  public:
    SdaiVector_or_direction_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_vector_or_direction );
