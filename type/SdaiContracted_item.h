...
// constructors
    SdaiContracted_item( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_contracted_item );
    //  part 1
    SdaiContracted_item( const SdaiProduct_definition_formation_ptr&,
                         const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_contracted_item );
...
class SdaiContracted_item_agg : public SelectAggregate {
  ...
  public:
    SdaiContracted_item_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_contracted_item );
