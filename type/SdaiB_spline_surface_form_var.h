...
class SC_SCHEMA_EXPORT SdaiB_spline_surface_form_var  :  public SDAI_Enum  {
  ...
  public:
        SdaiB_spline_surface_form_var (const char * n =0, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_b_spline_surface_form);
        SdaiB_spline_surface_form_var (B_spline_surface_form e, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_b_spline_surface_form)
                : type(et) {  set_value (e);  }
...
class SdaiB_spline_surface_form_var_agg  :  public EnumAggregate  {
  ...
  public:
    SdaiB_spline_surface_form_var_agg( EnumTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_b_spline_surface_form);
