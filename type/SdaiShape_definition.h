...
// constructors
    SdaiShape_definition( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_shape_definition );
    //  part 1
    SdaiShape_definition( const SdaiProduct_definition_shape_ptr&,
                          const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_shape_definition );
...
class SdaiShape_definition_agg : public SelectAggregate {
  ...
  public:
    SdaiShape_definition_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_shape_definition );
