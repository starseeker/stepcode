...
// constructors
    SdaiSupported_item( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_supported_item );
    //  part 1
    SdaiSupported_item( const SdaiAction_ptr&,
                        const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_supported_item );
...
class SdaiSupported_item_agg : public SelectAggregate {
  ...
  public:
    SdaiSupported_item_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_supported_item );
