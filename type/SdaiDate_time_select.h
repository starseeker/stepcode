...
// constructors
    SdaiDate_time_select( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_date_time_select );
    //  part 1
    SdaiDate_time_select( const SdaiDate_ptr&,
                          const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_date_time_select );
...
class SdaiDate_time_select_agg : public SelectAggregate {
  ...
  public:
    SdaiDate_time_select_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_date_time_select );
