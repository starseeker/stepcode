...
class SC_SCHEMA_EXPORT SdaiTransition_code_var  :  public SDAI_Enum  {
  ...
  public:
        SdaiTransition_code_var (const char * n =0, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_transition_code);
        SdaiTransition_code_var (Transition_code e, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_transition_code)
                : type(et) {  set_value (e);  }
...
class SdaiTransition_code_var_agg  :  public EnumAggregate  {
  ...
  public:
    SdaiTransition_code_var_agg( EnumTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_transition_code);
