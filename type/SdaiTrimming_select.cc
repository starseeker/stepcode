...
SdaiTrimming_select::SdaiTrimming_select( const SdaiParameter_value& o,
                                          const SelectTypeDescriptor *typedescript )
  : SDAI_Select (typedescript, ap242_managed_model_based_3d_engineering_mim_lf::t_parameter_value)
{
#ifdef SC_LOGGING
    if( *logStream ) { *logStream << "DAVE ERR entering SdaiTrimming_select constructor." << std::endl; }
#endif
...
SdaiTrimming_select& SdaiTrimming_select::operator =( const SdaiParameter_value& o )
{
   nullify ();
   _real = o;
   SetUnderlyingType( ap242_managed_model_based_3d_engineering_mim_lf::t_parameter_value );
   return *this;
}
...
void init_SdaiTrimming_select( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select = new SelectTypeDescriptor (
                  ~(0),        //unique elements,
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select);
    ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select -> Elements ().AddNode (ap242_managed_model_based_3d_engineering_mim_lf::e_cartesian_point);
    ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select -> Elements ().AddNode (ap242_managed_model_based_3d_engineering_mim_lf::t_parameter_value);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select);
}
