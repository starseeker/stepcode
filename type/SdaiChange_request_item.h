...
// constructors
    SdaiChange_request_item( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_change_request_item );
    //  part 1
    SdaiChange_request_item( const SdaiProduct_definition_formation_ptr&,
                             const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_change_request_item );
...
class SdaiChange_request_item_agg : public SelectAggregate {
  ...
  public:
    SdaiChange_request_item_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_change_request_item );
