...
// constructors
    SdaiTrimming_select( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select );
    //  part 1
    SdaiTrimming_select( const SdaiCartesian_point_ptr&,
                         const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select );
...
class SdaiTrimming_select_agg : public SelectAggregate {
  ...
  public:
    SdaiTrimming_select_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_select );
