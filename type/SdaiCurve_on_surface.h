...
// constructors
    SdaiCurve_on_surface( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_curve_on_surface );
    //  part 1
    SdaiCurve_on_surface( const SdaiComposite_curve_on_surface_ptr&,
                          const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_curve_on_surface );
...
class SdaiCurve_on_surface_agg : public SelectAggregate {
  ...
  public:
    SdaiCurve_on_surface_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_curve_on_surface );
