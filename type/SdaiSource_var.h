...
class SC_SCHEMA_EXPORT SdaiSource_var  :  public SDAI_Enum  {
  ...
  public:
        SdaiSource_var (const char * n =0, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_source);
        SdaiSource_var (Source e, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_source)
                : type(et) {  set_value (e);  }
...
class SdaiSource_var_agg  :  public EnumAggregate  {
  ...
  public:
    SdaiSource_var_agg( EnumTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_source);
