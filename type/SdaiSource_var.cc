...
{
    return new SdaiSource_var( "", ap242_managed_model_based_3d_engineering_mim_lf::t_source );
}
...
{
    return new SdaiSource_var_agg( ap242_managed_model_based_3d_engineering_mim_lf::t_source );
}

void init_SdaiSource_var( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_source = new EnumTypeDescriptor (
                  "Source",        // Name
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_source);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_source);
}
