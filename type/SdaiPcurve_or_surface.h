...
// constructors
    SdaiPcurve_or_surface( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_pcurve_or_surface );
    //  part 1
    SdaiPcurve_or_surface( const SdaiPcurve_ptr&,
                           const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_pcurve_or_surface );
...
class SdaiPcurve_or_surface_agg : public SelectAggregate {
  ...
  public:
    SdaiPcurve_or_surface_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_pcurve_or_surface );
