...
// constructors
    SdaiWork_item( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_work_item );
    //  part 1
    SdaiWork_item( const SdaiProduct_definition_formation_ptr&,
                   const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_work_item );
...
class SdaiWork_item_agg : public SelectAggregate {
  ...
  public:
    SdaiWork_item_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_work_item );
    ~SdaiWork_item_agg();
