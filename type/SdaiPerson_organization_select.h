...
// constructors
    SdaiPerson_organization_select( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_person_organization_select );
    //  part 1
    SdaiPerson_organization_select( const SdaiOrganization_ptr&,
                                    const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_person_organization_select );
...
class SdaiPerson_organization_select_agg : public SelectAggregate {
  ...
  public:
    SdaiPerson_organization_select_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_person_organization_select );
