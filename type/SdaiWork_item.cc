...
void init_SdaiWork_item( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_work_item = new SelectTypeDescriptor (
                  ~(0),        //unique elements,
                  "Work_Item",        // Name
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_work_item);
    ap242_managed_model_based_3d_engineering_mim_lf::t_work_item -> Elements ().AddNode (ap242_managed_model_based_3d_engineering_mim_lf::e_product_definition_formation);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_work_item);
}
