...
class SC_SCHEMA_EXPORT SdaiAhead_or_behind_var  :  public SDAI_Enum  {
  ...
  public:
        SdaiAhead_or_behind_var (const char * n =0, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_ahead_or_behind);
        SdaiAhead_or_behind_var (Ahead_or_behind e, EnumTypeDescriptor *et =ap242_managed_model_based_3d_engineering_mim_lf::t_ahead_or_behind)
                : type(et) {  set_value (e);  }
...
class SdaiAhead_or_behind_var_agg  :  public EnumAggregate  {
  ...
  public:
    SdaiAhead_or_behind_var_agg( EnumTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_ahead_or_behind);
