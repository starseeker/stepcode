...
{
    return new SdaiSi_unit_name_var( "", ap242_managed_model_based_3d_engineering_mim_lf::t_si_unit_name );
}
...
{
    return new SdaiSi_unit_name_var_agg( ap242_managed_model_based_3d_engineering_mim_lf::t_si_unit_name );
}

void init_SdaiSi_unit_name_var( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_si_unit_name = new EnumTypeDescriptor (
                  "Si_Unit_Name",        // Name
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_si_unit_name);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_si_unit_name);
}
