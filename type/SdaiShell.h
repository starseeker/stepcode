...
// constructors
    SdaiShell( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_shell );
    //  part 1
    SdaiShell( const SdaiClosed_shell_ptr&,
               const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_shell );
...
class SdaiShell_agg : public SelectAggregate {
  ...
  public:
    SdaiShell_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_shell );
    ~SdaiShell_agg();
