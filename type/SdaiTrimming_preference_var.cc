...
{
    return new SdaiTrimming_preference_var( "", ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_preference );
}
...
{
    return new SdaiTrimming_preference_var_agg( ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_preference );
}

void init_SdaiTrimming_preference_var( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_preference = new EnumTypeDescriptor (
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_preference);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_trimming_preference);
}
