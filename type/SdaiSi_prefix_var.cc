...
{
    return new SdaiSi_prefix_var( "", ap242_managed_model_based_3d_engineering_mim_lf::t_si_prefix );
}
...
{
    return new SdaiSi_prefix_var_agg( ap242_managed_model_based_3d_engineering_mim_lf::t_si_prefix );
}

void init_SdaiSi_prefix_var( Registry& reg ) {
    std::string str;
        ap242_managed_model_based_3d_engineering_mim_lf::t_si_prefix = new EnumTypeDescriptor (
                  "Si_Prefix",        // Name
        ...
        ap242_managed_model_based_3d_engineering_mim_lf::schema->AddType(ap242_managed_model_based_3d_engineering_mim_lf::t_si_prefix);
    reg.AddType (*ap242_managed_model_based_3d_engineering_mim_lf::t_si_prefix);
}
