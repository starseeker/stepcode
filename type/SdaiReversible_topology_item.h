...
// constructors
    SdaiReversible_topology_item( const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_reversible_topology_item );
    //  part 1
    SdaiReversible_topology_item( const SdaiClosed_shell_ptr&,
                                  const SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_reversible_topology_item );
...
class SdaiReversible_topology_item_agg : public SelectAggregate {
  ...
  public:
    SdaiReversible_topology_item_agg( SelectTypeDescriptor * =ap242_managed_model_based_3d_engineering_mim_lf::t_reversible_topology_item );
