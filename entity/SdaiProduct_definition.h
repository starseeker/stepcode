...
namespace ap242_managed_model_based_3d_engineering_mim_lf {
    ...
    extern AttrDescriptor *a_136id;
    extern AttrDescriptor *a_137description;
    extern AttrDescriptor *a_138formation;
    extern AttrDescriptor *a_139frame_of_reference;
    extern Derived_attribute *a_140Dname;
}
