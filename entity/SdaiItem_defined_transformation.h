...
namespace ap242_managed_model_based_3d_engineering_mim_lf {
    ...
    extern AttrDescriptor *a_37name;
    extern AttrDescriptor *a_38description;
    extern AttrDescriptor *a_39transform_item_1;
    extern AttrDescriptor *a_40transform_item_2;
}
