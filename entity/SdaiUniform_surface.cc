...
EntityDescriptor * ap242_managed_model_based_3d_engineering_mim_lf::e_uniform_surface = 0;
...
SdaiUniform_surface::SdaiUniform_surface(): SdaiB_spline_surface() {
    ...
    eDesc = ap242_managed_model_based_3d_engineering_mim_lf::e_uniform_surface;
...
void init_SdaiUniform_surface( Registry& reg ) {
    ...
    ap242_managed_model_based_3d_engineering_mim_lf::e_uniform_surface->AddSupertype(ap242_managed_model_based_3d_engineering_mim_lf::e_b_spline_surface);
    ap242_managed_model_based_3d_engineering_mim_lf::e_b_spline_surface->AddSubtype(ap242_managed_model_based_3d_engineering_mim_lf::e_uniform_surface);
        reg.AddEntity( *ap242_managed_model_based_3d_engineering_mim_lf::e_uniform_surface );
}
