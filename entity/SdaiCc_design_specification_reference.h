...
class SC_SCHEMA_EXPORT SdaiCc_design_specification_reference : public SdaiDocument_reference {
     protected:
        SdaiCc_specified_item_agg_ptr _items = NULL;          //  of  cc_specified_item
    ...
    public: 
        ...
        SdaiCc_specified_item_agg_ptr_c items_() const;
        SdaiCc_specified_item_agg_ptr   items_();
        void items_( const SdaiCc_specified_item_agg_ptr x );
...
namespace ap242_managed_model_based_3d_engineering_mim_lf {
    ...
    extern AttrDescriptor *a_3024items;
}
