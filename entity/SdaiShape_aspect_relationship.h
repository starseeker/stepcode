...
namespace ap242_managed_model_based_3d_engineering_mim_lf {
    ...
    extern AttrDescriptor *a_376name;
    extern AttrDescriptor *a_377description;
    extern AttrDescriptor *a_378relating_shape_aspect;
    extern AttrDescriptor *a_379related_shape_aspect;
    extern Derived_attribute *a_380Did;
}
