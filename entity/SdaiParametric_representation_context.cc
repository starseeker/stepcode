...
EntityDescriptor * ap242_managed_model_based_3d_engineering_mim_lf::e_parametric_representation_context = 0;
...
SdaiParametric_representation_context::SdaiParametric_representation_context(): SdaiRepresentation_context() {
    ...
    eDesc = ap242_managed_model_based_3d_engineering_mim_lf::e_parametric_representation_context;
}
...
void init_SdaiParametric_representation_context( Registry& reg ) {
    ...
    ap242_managed_model_based_3d_engineering_mim_lf::e_parametric_representation_context->AddSupertype(ap242_managed_model_based_3d_engineering_mim_lf::e_representation_context);
    ap242_managed_model_based_3d_engineering_mim_lf::e_representation_context->AddSubtype(ap242_managed_model_based_3d_engineering_mim_lf::e_parametric_representation_context);
        reg.AddEntity( *ap242_managed_model_based_3d_engineering_mim_lf::e_parametric_representation_context );
}
