...
namespace ap242_managed_model_based_3d_engineering_mim_lf {
    ...
    extern AttrDescriptor *a_518segments;
    extern AttrDescriptor *a_519self_intersect;
    extern Derived_attribute *a_520Dn_segments;
    extern Derived_attribute *a_521Dclosed_curve;
}
